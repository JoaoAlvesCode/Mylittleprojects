...
function validateCred(array){
  ...
  var modifiedArrayLength = array.length-2;
  var total = 0;
  var j = array.length-1;
  var i = modifiedArrayLength;
  // do loop to multiply second number
  do {
    var x = (array[i]*2)
  ...
  // checksum should not have any remainder when divided by 10
  checksum = total%10;
  if(checksum === 0){
    // valid card
    return true
...
function findInvalidCards(nestedArray){
  ...
  do {
    if(invalidCred(nestedArray[1])===false){
